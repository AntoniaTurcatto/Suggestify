...
public class ComboBoxTag {
    ...
    public ComboBoxTag(int key, String value) {
        this.key = key;
        this.value = value;
    }
    ...
    public static void preencheComboBoxMarca(int SelCodigo, JComboBox combo, ArrayList<Tag> lista, Boolean addTodos){
        ...
        for (Tag t: lista){ 
            ...
            ComboBoxAlbum cmb = new ComboBoxAlbum(t.getIdTag(),t.getTagTexto());
